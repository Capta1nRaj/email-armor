...
function signInVerify(username, otp, id) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const decryptedOTP = (otp === (yield decryptPassword(getDocumentViaID.OTP)));
            ...
            if (getDocumentViaID.userName === username.toLowerCase() && decryptedOTP === true) {
                ...
                yield sessionsModel.findByIdAndUpdate(id, { userVerified: true, $unset: { OTP: 1, OTPCount: 1 }, $set: { expireAt: new Date(Date.now() + 10 * 24 * 60 * 60 * 1000) } }, { new: true });
                return {
                    status: 202,
