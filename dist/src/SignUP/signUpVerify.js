    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (decryptedOTP === false) {
            ...
            if (getTheUserWhomHeGotReferred.userReferredBy.length === 0) {
                ...
                yield accountsModel.findOneAndUpdate({ userName: username.toLowerCase() }, { $set: { userVerified: true }, $inc: { points: 0 } }, { new: true });
                ...
                yield accountsModel.findOneAndUpdate({ userName: username.toLowerCase() }, { $set: { userVerified: true }, $inc: { points: fetchSettings.referred_person_points } }, { new: true });
                ...
                yield accountsModel.findOneAndUpdate({ userName: getTheUserWhomHeGotReferred.userReferredBy }, { $addToSet: { userReferrals: getTheUserWhomHeGotReferred.userName }, $inc: { points: fetchSettings.referred_points } }, { new: true });
            }
            // Delete The OTP From otpModel Collection
            yield otpModel.findOneAndDelete({ userName: username.toLowerCase() });
            return {
                status: 202,
