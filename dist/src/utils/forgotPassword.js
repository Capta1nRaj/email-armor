            ...
            if (username.toLowerCase() !== undefined && OTP === undefined && newPassword === undefined) {
                ...
                if (finduserAndSendEmailForVerification === null) {
                    ...
                    if (checkIfUserAlreadyRequestedForOTP === null) {
                        ...
                        yield sendOTPToUser(finduserAndSendEmailForVerification.userName, finduserAndSendEmailForVerification.userEmail, userOTP, 'forgotPassword', userIP);
                        ...
                        yield checkIfUserAlreadyRequestedForOTP.save();
                        return {
                            status: 201,
                            message: "OTP Sent To Mail",
                            userName: username.toLowerCase(),
                ...
                if (decryptedOTP === false) {
                    ...
                    yield accountsModel.findOneAndUpdate({ userName: username.toLowerCase() }, { userPassword: encryptedPassword }, { new: true });
