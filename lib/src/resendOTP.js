...
function resendOTP(username, functionPerformed, token, id) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (functionPerformed === 'newUserVerification') {
            ...
            // Sending OTP To User
            yield sendOTPToUser(userName, findUserAndSendEmail === null || findUserAndSendEmail === void 0 ? void 0 : findUserAndSendEmail.userEmail, userOTP, 'signUp');
            return {
                status: 201,
            ...
            try {
                ...
                if (findUserSessionViaID.userName === userName && findUserSessionViaID.token === token && userIP === userIPDecrypted) {
                    ...
                    const encryptOTP = yield encryptPassword(userOTP);
                    // Find & update OTP
                    yield otpModel.findOneAndUpdate({ userName }, { $set: { OTP: encryptOTP }, $inc: { OTPCount: 1 } });
                    // Finding The Email Of The User
                    const findUserAndSendEmail = yield accountsModel.findOne({ userName });
                    // Sending The OTP To The User
                    yield sendOTPToUser(userName, findUserAndSendEmail.userEmail, userOTP, 'signIn');
                    return {
                        status: 201,
                        message: "OTP Resent To The User.",
                    };
            ...
            const findUserAndSendEmail = yield accountsModel.findOne({ userName });
            // Sending OTP To User
            yield sendOTPToUser(userName, findUserAndSendEmail === null || findUserAndSendEmail === void 0 ? void 0 : findUserAndSendEmail.userEmail, userOTP, 'forgotPassword');
            return {
                status: 201,
                message: "OTP Resent To The User.",
            };
