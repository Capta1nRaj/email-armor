...
function signin(username, userPassword) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!findUserToLogin.userVerified) {
            ...
            yield sendOTPToUser(username.toLowerCase(), findUserToLogin.userEmail, userOTP, 'signUp');
            return {
                status: 401,
        ...
        if (findUserToLogin.userName === username.toLowerCase() && decryptedPassword) {
            ...
            // Sending OTP To User Registered E-Mail
            yield sendOTPToUser(username.toLowerCase(), findUserToLogin.userEmail, userOTP, 'signIn');
            return {
                status: 201,
